...
public class MyTestWebAppServiceFactory : SharedObjectFactory<TestWebAppService>
{
    public static readonly MyTestWebAppServiceFactory Factory = new MyTestWebAppServiceFactory();

    protected override TestWebAppService CreateNewImpl()
    {
        MyTestWebAppHook hook = new MyTestWebAppHook();

        TestWebAppServiceStartupParam options = new TestWebAppServiceStartupParam();

        return new TestWebAppService(options, hook);
    }
}
...
public class Startup
{
    ...
    readonly SharedObjectHolder<TestWebAppService> ServiceHolder;
    readonly StrTableLanguageList LanguageList = new StrTableLanguageList();

    public TestWebAppService Service => ServiceHolder.Object;
    ...
    public Startup(IConfiguration configuration)
    {
        ...
        this.ServiceHolder = MyTestWebAppServiceFactory.Factory.CreateOrGet();

        // ThinWebClient の利用すべき StrTable を設定する
        this.Service.SetLanguageList(this.LanguageList);
    }
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IHostApplicationLifetime lifetime)
    {
        ...
        {
            app.UseExceptionHandler("/TestWebApp/Error");
        }
        ...
        app.UseEndpoints(endpoints =>
        {
            endpoints.MapControllerRoute(
                name: "default",
                pattern: "{controller=TestWebApp}/{action=Index}/{id?}");
        });
